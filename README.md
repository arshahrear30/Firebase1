...
আর device token id device এ usb দিয়ে connect করা অবস্থায় logcat এ token দিয়ে search করে বের করে নিবো এবং firebase.php  এর শুরুতে token এ বসিয়ে নিবো । 
...
$accessToken = getAccessToken($serviceAccountKeyFile);  এই তিনটা লাইন । 
👉15👈
